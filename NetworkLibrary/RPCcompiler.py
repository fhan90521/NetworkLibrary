...
while True:
    ...
    if line == '{':
        break
#c++ 기본타입
basic_type = ["int","unsigned int","short", "unsigned short","long","unsigned long","long long","unsigned long long","bool","char","unsigned char","float","double","ULONG64", "LONG64","BYTE","INT64","WORD","USHORT"]
#함수 한 줄씩 읽기
while True:
